# OTM Platform / Internal Tools UX Guidelines

The single source of truth for the look and feel of OTM (Old Town Media) internal tools, dashboards, and applications. Use this when building any internal tool in Cursor and deploying to Railway. For WordPress plugins, use the [`wordpress-plugins/`](../wordpress-plugins/) set instead.

> Part of the [OTM UX Guidelines](../README.md) collection. This is the **platform / internal tools** set (full navy app shell, OAuth, Railway).
